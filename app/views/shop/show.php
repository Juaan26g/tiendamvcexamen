...
<?php elseif ($data['data']->type == 2): ?>
    ...
    <?= html_entity_decode($data['data']->description) ?>
<?php endif; ?>
<a href="<?= ROOT . (!empty($data['back']) ? $data['back'] : 'shop') ?>" class="btn btn-success"> Volver al listado de <?php if ($data['data']->type == 1):  ?> cursos <?php elseif ($data['data']->type == 2): ?> libros <?php endif; ?></a>
